...
public class CasConfig {
     ...
     */
    public static String SERVER_NAME = "http://localhost:8181/boss";
    ...
    public FilterRegistrationBean filterAuthenticationRegistration() {
        ...
        // 表示过滤所有
        initParameters.put("ignoreUrlPatternType", "com.pay.credit.cloud.prom.config.SimpleUrlPatternMatcherStrategy");
    ...
    /**
     * SingleSignOutFilter 登出过滤器 该过滤器用于实现单点登出功能，可选配置
     *
     * @return
     */
    @Bean
    ...
    /*
     * HttpServletRequestWrapperFilter wraper过滤器 该过滤器负责实现HttpServletRequest请求的包裹，
